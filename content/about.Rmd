...
* Second blog and first personal website created using blogdown in R studio, and presented github and netlify. The entire website includes examples of elementary coding such as images, hyperlinks, bold and italicized text, headers, centered and indented text, emojis, and a footer signature with link to my Github profile. 
...
**:pill: [COVID-19](https://rbolt13.github.io/covid19/)** <br> Summer 2021 - Current<br> _Personal_

*  Created in R Studio and presented through a Github repository, 6 different data sets from NYT repository along with data from tidycensus package were used to create tables of percentages of  cases, deaths, and vaccinations for states and Oregon couties. 
...
* Incomplete this site serves as more of a play pen for data and data visual exploration. Future explorations might include graphs and maps with ggplot, and potentially a shiny app. 
...
* Read [blogdown: Creating Websites with R Markdown](https://bookdown.org/yihui/blogdown/), watched videos, and read articles on how to create a blog with blogdown in rstudio.

* First blog in blogdown tracks my garden in written and visual posts. 

* Scrapped early due to time demand of taking, uploading, and digitally filing images. 
...
**:cricket: [Statistics - 462 : Introduction to Mathematical Statistics II](https://rbolt13.github.io/stat462/)** <br> Winter 2022 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  _Professor Nadee Jayasena_  

**Topics Covered :** Pending 

**:lady beetle: [Mathematics - 388 : Modern College Geometry](https://rbolt13.github.io/mth388/)** <br> Winter 2022 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  _Professor Rebecca Tramel_  

**Topics Covered :** Pending

**:beetle: [Mathematics - 344 : Introduction to Group Theory Application](https://rbolt13.github.io/mth344/)** <br> Winter 2022 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  _Professor Julie Bracken_  
...
### Book Notes ~
**:scroll: [An Introduction to Abstract Mathematics](https://rbolt13.github.io/itam/)** 
