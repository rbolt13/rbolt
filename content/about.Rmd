...
* Future blog posts will include examples in R from linear regression annalysis, proving least squares estimates, blogdown tutorial, first shiny app, simple shiny tutorial, probability distributions, tree diagrams, bayes theorem, simple g.i.s., basketball stats, and spotifyr. 
