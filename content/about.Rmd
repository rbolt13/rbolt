...
*  Created in R Studio and presented through Github repositories, 6 different data sets from NYT repository along with data from tidycensus package to create tables of percentages of various states and Oregon county's cases, deaths, and vaccinations. 

* An API was used in .Renviron that is ignored by Github. The main page also include an interactive table of contents. 

* Joined data sets, created colomns for calculated percentages, filtered by date, and created "top 5" tables with gt().
